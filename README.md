...
| Hackathon                    | Place        | Task                                                                 | Stack                                                                                                  | Category                         | GitHub Link                                                       |
|------------------------------|--------------|----------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------|----------------------------------|-------------------------------------------------------------------|
| **Gagarin Hack**             | 2nd place    | Classification of documents based on photos, extraction of attributes | opencv, yolo, easyocr                                                                                   | CV                               | [Link](https://github.com/l1ghtsource/gagarin-hack-document-reader) |
| **EESTech Hack**             | 2nd place    | Predicting tractor components state based on telemetry data           | catboost, sklearn, streamlit                                                                            | Classic ML                       | [Link](https://github.com/l1ghtsource/eestech-hack-tractor-forecasting) |
| **Digital Breakthrough (UFD)** | 3rd place   | Predict segment of advertising creative                               | whisper, bert, x-clip, llava, catboost, fastapi                                                         | Speech & Video                   | [Link](https://github.com/l1ghtsource/mediawise-creative-filter)  |
| **MIPT Hack**                | 1st place    | Recognizing place on MIPT campus for a mobile robot                   | torch, opr, transformers, faiss                                                                         | Place Recognition, Metric Learning | [Link](https://github.com/l1ghtsource/mipt-hackathon)             |
| **IT Purple Hack**           | 4th place    | Forecasting banking client churn                                      | catboost, sklearn, imblearn, optuna                                                                     | Classic ML                       | [Link](https://github.com/l1ghtsource/it-purple-hack-sber-case)   |
| **RedLab Hack**              | 4-5th place  | Detecting anomalies in a time series                                  | orion, adtk, sklearn, prophet, keras, streamlit                                                         | Classic ML, Timeseries            | [Link](https://github.com/l1ghtsource/redlab-timeseries-anomaly-detection) |
| **Tender Hack**              | 6th place    | Generating CTE names and characteristics                              | transformers, torch, catboost                                                                           | NLP                              | [Link](https://github.com/l1ghtsource/tender-hack-product-card-generator) |
| **LCT**                      | Participant  | Index and search videos based on media content                        | torch, whisper, clip4clip, easyocr, transformers, faiss, face_recognition                               | Video, Speech, CV                | [Link](https://github.com/l1ghtsource/media-searcher)             |
| **Rucode Start**             | Finalist     | Disease prediction, segmentation of satellite images, prediction of hotel room cancellations | sklearn, catboost, imblearn, autogluon, bluecast, torch, albumentations, segmentation_models | Classic ML, CV                    | [Link](https://github.com/l1ghtsource/rucode-start-2024)          |
